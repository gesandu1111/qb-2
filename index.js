...
async function connectToWA() {
  ...
  console.log("Connecting ❤️G_E_S_A❤️");
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("❤️G_E_S_A❤️ installed successful ✅");
      console.log("❤️G_E_S_A❤️ connected to whatsapp ✅");

      let up = `❤️G_E_S_A❤️ connected successful ✅`;
      let up1 = `Hello Gesa, I made bot successful`;
      ...
      robin.sendMessage("94753362282@s.whatsapp.net", {
        image: {
          url: `https://github.com/gesandu1111/2026-2/blob/main/WhatsApp%20Image%202025-12-31%20at%2010.33.02.jpeg?raw=true`,
        },
        caption: up1,
